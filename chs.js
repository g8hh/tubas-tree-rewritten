...
var cnItems = {
    ...
    "'no u'": "'不是 u'",
    "Shards+": "碎片+",
    "super-boosters": "超级助推器",
    "super-boosters, multiplying the booster base by": "超级助推器，将助推器基础乘以",
    "Super-Boosting To The Max": "超级提升到最大",
    "The booster base is multiplied based on ascension tokens.": "助推器基数根据提升令牌成倍增加。",
    "The Other Prestige Key": "另一个威望钥匙",
    "The Transcension Key": "超越钥匙",
    "Then wait less! Gain 3x more ascension tokens.": "那就少等吧！获得 3 倍以上的提升令牌。",
    "Transcended Points": "超越点",
    "Transcendental Power": "超验的力量",
    "Transcendental Tripler": "超越三倍体",
    "Transcension Bonus": "超越奖金",
    "Unlock 3 new booster upgrades.": "解锁 3 个新的助推器升级。",
    "Unlock a buyable for Ascension.": "为 转生 解锁可购买的物品。",
    "Unlock another buyable for Ascension.": "为 转生 解锁另一个可购买的物品。",
    "Wait a minute...": "等一下...",
    "We need to make boosters better! Unlock Super-Boosters.": "我们需要让助推器变得更好！解锁超级助推器。",
    "When you respec, you will not get your ascension tokens back!": "当您重新指定时，您将无法取回您的提升令牌！",
    "Yay, we're back here again! Let's make super-boosters more effective.": "耶，我们又回来了！让我们让超级助推器更有效。",
    "You're getting impatient, aren't you? Tokens no longer reset on transcension.": "你越来越不耐烦了，是吗？令牌不再在超越时重置。",
    "New Layer???": "新层？？？",
    "Prestige Point Booster": "威望点助推器",
    "Respec ascension token buyables": "Respec提升令牌可购买",
    "Shard & Booster Fusion": "碎片和助推器融合",
    "Shard Self-Synergy": "分片自我协同",
    "Shard Tickspeed": "碎片滴答速度",
    "Shards are terrible! Greatly boost the shards effect.": "碎片太可怕了！大幅提升碎片效果。",
    "Shards boost ascension point gain.": "碎片提升提升点增益。",
    "A New Type???": "新类型？？？",
    "All shard generators are more effective based on total transcension points.": "基于总超越点，所有分片生成器都更有效。",
    "ASCENDED Boosters": "升华助推器",
    "Ascension Point Multiplier": "提升点乘数",
    "Autobuy the first ascension buyable.": "自动购买 可购买的第一次提升。",
    "Autobuy the second ascension buyable.": "自动购买 第二次提升可购买。",
    "Booster Division": "助推器事业部",
    "By default, you gain 2 ascension tokens for every achievement you have in Row 5+": "默认情况下，您在第 5 行以上的每个成就都会获得 2 个提升标记",
    "Column Leader": "列长",
    "Divine Shards": "神圣碎片",
    "Everlasting Tokens": "永恒的令牌",
    "Gain 3x more transcension points.": "获得 3 倍以上的超越点。",
    "Gain more ascension points based on total transcension points.": "根据总的超越点获得更多的提升点。",
    "Gain more shards based on shards.": "根据碎片获得更多碎片。",
    "Gain more transension points based on points.": "根据点数获得更多的超越点数。",
    "I'm tired of waiting...": "我厌倦了等待...",
    "It turns out that boosters and shards mutally benefit each other! Boosters and shards boost each other.": "事实证明，助推器和碎片互惠互利！助推器和碎片相互促进。",
    "It's time to strategize! Unlock Ascension Tokens.": "是时候制定战略了！解锁提升令牌。",
    "Key to success? Unlock new upgrades???": "成功的关键？解锁新升级？？？",
    "Make the achievements boost to prestige tokens stronger.": "使声望令牌的成就提升更强。",
    "Make the two upgrades above more effective.": "让上面的两个升级更有效。",
    "More AP": "更多转生点",
    "more waiting lol": "更多等待哈哈",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "shards, multiplying point, prestige point, and ascension point gain by": "碎片，乘数，声望点和转生点增益",
    "Multiply prestige point gain by ": "声望点增益乘以 ",
    "Multiply ascension point gain by ": "转生点增益乘以 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^You have (.+) ascension tokens$/, '你有 $1 转生代币'],
    ...
    [/^(.+) every time you buy this!\nTimes Bought: (.+)\nCost: (.+)\nEffect: (.+)x prestige points$/, '每次购买 $1！\n 购买次数：$2\成本：$3\n效果：$4x 声望点'],
    [/^(.+) every time you buy this!\nTimes Bought: (.+)\nCost: (.+) ascension tokens\nEffect: (.+)x ascension points$/, '每次购买 $1！\n 购买次数：$2\成本：$3 转生代币\n效果：$4x 转生点'],
    [/^Multiply point gain by (.+) every time you buy this!\nTimes Bought: (.+)\nCost: (.+)\nEffect: (.+)x points$/, '每次购买时，点数收益乘以 $1！\n购买次数：$2\n成本：$3\n效果：$4x 点数'],
    [/^Divide the booster cost by (.+) every time you buy this!\nTimes Bought: (.+)\nCost: (.+) ascension tokens\nEffect: \/(.+) booster cost$/, '每次购买时将助推器成本除以 $1！\n购买次数：$2\n成本：$3 升华代币\n效果：\/$4 助推器成本'],
    [/^Multiplies all other Shard Generators by (.+)x per purchase.\nAmount: (.+)\nCost: (.+)\nMultiplier: (.+)x$/, '每次购买将所有其他碎片生成器乘以 $1x。\n金额：$2\n成本：$3\n乘数：$4x'],
    [/^Shards x(.+), Booster Base x(.+)$/, '碎片 x$1，助推器基础 x$2'],
    [/^You are gaining (.+) ascension points per second$/, '你每秒获得 $1 提升点'],
    ...
    [/^([\d\.,]+) super-boosters$/, '$1 超级助推器'],
    [/^([\d\.]+)e([\d\.,]+) ascension points$/, '$1e$2 转生点'],
    [/^([\d\.]+)e([\d\.,]+) transcension points$/, '$1e$2 超越点'],
    ...
    [/^Cost: (.+) prestige tokens$/, '成本：$1 声望代币'],
    [/^Cost: (.+) ascension tokens$/, '成本：$1 转生代币'],
    [/^Cost: (.+) transcension points$/, '成本：$1 超越点数'],
    [/^Cost: (.+) points$/, '成本：$1 点数'],
    [/^Req: (.+) \/ (.+) points$/, '成本：$1 \/ $2 点数'],
    [/^Req: (.+) \/ (.+) boosters$/, '成本：$1 \/ $2 助推器'],
